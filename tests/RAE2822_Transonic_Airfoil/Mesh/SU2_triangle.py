...
try:
    result = subprocess.run(
        [triangle_executable, "-pc", "-ne", boundaries_file],
...
try:
    subprocess.run(["showme", "na00.1"], check=True)
    print("✅ ShowMe executed successfully!")
except FileNotFoundError:
    print("❌ Error: 'showme' command not found. Ensure it is installed and in the system PATH.")
except subprocess.CalledProcessError as e:
    print(f"❌ ShowMe execution failed: {e}")
