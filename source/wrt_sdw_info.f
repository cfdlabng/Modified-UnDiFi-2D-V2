...
!       watch out: conditions SPX not added because not tested yet.
     ...
     +                ispclr(k,isppnts)
          ...
          elseif(typespecpoints(isppnts).eq.'WDGX')then           ! boundary special point: 
            nshe=1                                                ! Shock point originating at the leading edge of a wedge. !vivek
            idummy=idummy+nshe                                    ! floating along x direction
          ...
          elseif(typespecpoints(isppnts).eq.'WDGY')then            ! boundary special point: inlet point
            nshe=1                                                 ! Shock point originating at the leading edge of a wedge.
            idummy=idummy+nshe                                     ! floating along y direction
